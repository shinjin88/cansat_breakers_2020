...
class Gpio:
    ...
    def setPWM(self,gpionum,pulse_width=500):#500~2500
        self.gpio.gpio.set_servo_pulsewidth(gpionum,pulse_width)
...
class MotorControl:
    ...
    def __init__(self,PinR1,PinR2,PinL1,PinL2,instanceofGpio=None):
        if instanceofGpio == None:
            self.gpio = Gpio()
        else:
            self.gpio = instanceofGpio
        self.R1 = PinR1
        self.R2 = PinR2
        self.L1 = PinL1
        self.L2 = PinL2
